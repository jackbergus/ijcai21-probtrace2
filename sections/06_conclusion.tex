...
Balancing between likelihood of the model trace with respect to which we are computing the alignment and the cost of the alignment (if the cost of the alignment is too high even if the model trace is very high applying too many changes in the original trace is again not very likely). 