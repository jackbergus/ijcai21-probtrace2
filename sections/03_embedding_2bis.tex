...
\begin{figure}[!t]
	\centering
	\vspace{-4mm}
	\subfloat{\label{fig:spp}\includegraphics[width=.22\textwidth]{images/original_space.pdf}}
	\subfloat{\label{fig:knnspace}\includegraphics[width=.22\textwidth]{images/transformed_space.pdf}}\\
...
\begin{table}[!t]
	...
	\centering
	\resizebox{.25\textwidth}{!}{\begin{tabular}{>{\centering\arraybackslash} m{1cm}| >{\centering\arraybackslash} m{4cm} >{\centering\arraybackslash} m{1cm} >{\centering\arraybackslash} m{1cm} }
			\toprule
			$\nonlogtrace$&$G_\nonlogtrace$&$l$&$\omega$\\
			\midrule
...
%\end{proof}
%
Due to weak equality and strong similarity, the embedding is weakly-ideal. {By Lemmas~\ref{lem:addedForOurPropos} and \ref{lem:sdiss}, all combinations of sub-embeddings from Table~\ref{tab:embedstrat} give weakly-ideal $G$-embeddings.} 
