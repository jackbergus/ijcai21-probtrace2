...
%=======
%		\textbf{STPETRI\_20} & \multicolumn{2}{c||}{Rogge-Solti \cite{RoggeSoltiAW13}} & $20$ & $10^{-5}$ & $1612$ \\
%>>>>>>> d827885802f87ae7a5bdd2dd2dc2e2ef582f6737
		\bottomrule
	\end{tabular}
\end{adjustbox}
\end{table}
