...
like to return the best $k$ alignments among all the distinct \unravelled\ model traces in $\WCal{p_\theta}{n}(P)$. In the database community, this problem is usually tackled via $k$-Nearest Neighbours.
...
\ADD{We overcome these shortcomings by} \begin{alphalist}
