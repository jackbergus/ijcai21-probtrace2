...
meaningful as an alignment. This trade-off must be treated carefully. Users can be supported in choosing the best alignment in each specific case if, instead of being provided with a single alignments, they are provided with a ranking of alignments.
