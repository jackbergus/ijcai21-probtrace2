...
\begin{figure}[!t]
	\centering
	\subfloat[A sample \uswn. Labels are shown in green, invisible transitions in grey, and weights in magenta.]{\label{fig:spn}\includegraphics[width=.4\textwidth]{images/petri.pdf}}\hfill
    \subfloat[Reachability graph of the \uswn in (a). Probabilities are shown in violet.]{\label{fig:rg}\includegraphics[width=.4\textwidth]{images/rg.pdf}}
    \\
\vspace*{-4.5mm}
	\subfloat[Transition graph encoding the reachability graph in (b).]{\label{fig:lmc}\label{fig:orig}\includegraphics[width=.4\textwidth]{images/running_example.pdf}}
    \hfill
    \subfloat[Transition graph resulting from the transition graph in (c) after $\tau$-closure.]{\label{fig:closed}\includegraphics[width=.4\textwidth]{images/closed_example.pdf}}
