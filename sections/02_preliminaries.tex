...
\begin{figure}[!t]
	...
	\subfloat[Reachability Graph Transformed as a Transition Graph.]{\label{fig:lmc}\label{fig:orig}\includegraphics[width=.45\textwidth,trim=-1.2cm 0cm -1.2cm 0cm]{images/running_example.pdf}} \hfill 
	\subfloat[Transition Graph after $\varepsilon$-closure.]{\label{fig:closed}\includegraphics[width=.45\textwidth]{images/closed_example.pdf}}
