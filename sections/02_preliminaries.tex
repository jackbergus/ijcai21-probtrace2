...
\begin{figure*}[!t]
	\begin{minipage}{.49\textwidth}
		...
		\caption{A sample \uswn $N$. Labels are shown in green, invisible transitions in grey, and weights in magenta.}\label{fig:spn}
	...
	\begin{minipage}{.49\textwidth}
	\includegraphics[width=.9\textwidth]{images/running_example.pdf}
