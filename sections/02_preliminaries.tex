...
>>>>>>> 270b8e33d91fe779b180ca69d457eeef3b3d5985
...
\begin{figure}[!t]
    ...
    \\
	\subfloat[Reachability Graph transformed into a Transition Graph.]{\label{fig:lmc}\label{fig:orig}\includegraphics[width=.48\textwidth]{images/running_example.pdf}}\subfloat[Transition Graph after $\varepsilon$-closure.]{\label{fig:closed}\includegraphics[width=.45\textwidth]{images/closed_example.pdf}}
