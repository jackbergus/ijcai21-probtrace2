...
\begin{tikzpicture}[align=center,node distance=3cm]
    ...
    \vertex{above}{$\color{green}c$}{b2}{initial}{below right}{3}
        \vertex{above}{$\color{green}a$}{b}{right of=b2}{below right}{4}
        \vertex{above}{$\color{green}a$}{b1}{right of=b,accepting,state,scale=0.4}{below right}{6}

    
   
    \myedge{b2}{above}{$\scriptscriptstyle{\color{red}p_4}$}{b}
    \myedge{b}{above}{$\scriptscriptstyle{\color{red}p_4}$}{b1}
