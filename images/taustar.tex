...
\begin{document}
	...
	\node[config,right=of s2,label={right,xshift=-1mm,yshift=-1.5mm}:\tcolor$c$]       (s3) {3};
	\node[config,accepting,right=of s3,label={right,xshift=-1mm,yshift=-1.5mm}:\tcolor$b$]       (s4) {3};
