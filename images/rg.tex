...
\draw[link] 
  ...
  node[left]{\color{gray}$\tau$}
  (ii);

\draw[link] 
  (ii) 
  -- 
  node[above,font=\scriptsize]{\color{violet}$\prob_{23} = \frac{v_{\tau_2}}{v_{\tau_2}+v_c}$} 
  node[below]{\color{gray}$\tau$}
  (iii);

\draw[link] 
  (ii) 
  -- 
  node[above,font=\scriptsize]{\color{violet}$\prob_{24} = \frac{v_c}{v_{\tau_2}+v_c}$} 
...
\draw[link,rounded corners=4pt,] 
  (v) 
  |-
  node[above left,font=\scriptsize]{\color{violet}$\prob_{5\mathit{f}} = \frac{v_{\tau_3}}{v_{a_2}+v_{\tau_3}}$} 
  node[below left,xshift=-10mm]{\color{gray}$\tau$}
  (vii);
...
\draw[link,rounded corners=4pt] 
  ...
  node[below,font=\scriptsize,yshift=1mm,xshift=-3mm]{\color{violet}$\prob_{55} = \frac{v_{a_2}}{v_{a_2}+v_{\tau_3}}$} 
  node[above left,xshift=-1.5mm]{\color{gray}$\tau$}
  |-
  (v.east);
