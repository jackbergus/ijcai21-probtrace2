...
\begin{tikzpicture}[align=center,node distance=.5cm]
  ...
  \draw[link] 
      (s1) 
      -- 
      node[xshift=2mm,yshift=-2mm]{\color{violet}$\rho_{23}$}
      (s9);
  \draw[link] 
      (s1) 
      -- 
      node[xshift=2mm,yshift=2mm]{\color{violet}$\rho_{24}$}
      (s3);
\end{tikzpicture}
...
%
%    \node[state] {\color{blue}1};    
%
%    \vertex{above}{$\color{green}\tau_\texttt{\color{blue}1}$}{s}{initial}{right}{1}
%    \vertex{above left}{$\color{green}\tau_\texttt{\color{blue}2}$}{bp}{above right of=s}{below right}{9}
...
%    \vertex{above left}{$\color{green}\tau_\texttt{\color{blue}3}$}{e2}{right of=b2}{below right}{10}
%    
...
%    \vertex{above}{$\color{green}\tau_\texttt{\color{blue}f}$}{bk}{right of=b,accepting,state,scale=0.4}{below right}{8}
%    \vertex{above right}{$\color{green}\tau_\texttt{\color{blue}4}$}{f}{right of=b1}{below right}{7}
%    
%    %
