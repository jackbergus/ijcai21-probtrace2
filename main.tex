...
\input{sections/01_introductionIJCAI}
\input{sections/02_preliminariesIJCAI}
\input{sections/03_embeddingIJCAI}
\input{sections/03_embedding_2bis}
\input{sections/05_experiment}
\input{sections/05b_approaches}
\input{sections/05b_biologseq.tex}
\input{sections/05d_planseq.tex}
